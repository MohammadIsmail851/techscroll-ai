...
export default function HeroSection({ onRunAnalysis }) {
  ...
  return (
    <section ref={heroRef} className="relative min-h-[90vh] flex flex-col justify-center items-center text-center px-4 overflow-hidden pt-12 pb-20">
      
      {/* Background Animated Particles & Nodes */}
      <div className="absolute inset-0 pointer-events-none grid-bg opacity-40"></div>
      
      {/* Gradient Glow Spheres */}
      <div className="gradient-glow w-96 h-96 bg-purple-600 top-1/4 left-1/4 -translate-x-1/2 -translate-y-1/2"></div>
      <div className="gradient-glow w-96 h-96 bg-cyan-500 bottom-1/4 right-1/4 translate-x-1/2 translate-y-1/2"></div>
      ...
      <div className="relative z-10 max-w-5xl mx-auto space-y-8">
        ...
        <div className="pt-6 flex flex-wrap items-center justify-center gap-4">
          <button
            ...
            className="px-8 py-4 rounded-2xl bg-gradient-to-r from-purple-600 via-indigo-600 to-cyan-500 text-white font-extrabold text-base tracking-wide shadow-xl shadow-purple-600/30 hover:shadow-purple-600/60 hover:scale-[1.03] active:scale-[0.98] transition-all flex items-center gap-3"
          >
          ...
          <a
            href="#reel-history"
            className="px-6 py-4 rounded-2xl glass-panel text-slate-200 hover:text-white font-semibold text-sm border border-slate-700 hover:border-slate-500 transition-all flex items-center gap-2"
          >
        ...
        <div className="pt-12 grid grid-cols-2 md:grid-cols-4 gap-4 max-w-4xl mx-auto text-left">
          <div className="p-4 rounded-xl glass-panel border border-white/5 space-y-1">
            <div className="flex items-center gap-2 text-purple-400 text-xs font-mono font-bold uppercase">
              <Brain className="w-4 h-4" /> <span>01 Semantic Analysis</span>
            </div>
          ...
          <div className="p-4 rounded-xl glass-panel border border-white/5 space-y-1">
            <div className="flex items-center gap-2 text-cyan-400 text-xs font-mono font-bold uppercase">
              <Layers className="w-4 h-4" /> <span>02 Cross-Reel Signal</span>
            </div>
          ...
          <div className="p-4 rounded-xl glass-panel border border-white/5 space-y-1">
            <div className="flex items-center gap-2 text-rose-400 text-xs font-mono font-bold uppercase">
              <Filter className="w-4 h-4" /> <span>03 Hype Filter</span>
            </div>
          ...
          <div className="p-4 rounded-xl glass-panel border border-white/5 space-y-1">
            <div className="flex items-center gap-2 text-emerald-400 text-xs font-mono font-bold uppercase">
              <Compass className="w-4 h-4" /> <span>04 Transparent WHY</span>
            </div>
